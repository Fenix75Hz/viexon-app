...
drop function if exists private.ensure_profile_can_assume_role(uuid, text);
...
begin
  ...
  set
    role = 'reseller'::public.user_role,
...
begin
  ...
  where public_id = p_reseller_public_id
    and is_public = true
    and status = 'active'::public.reseller_status
  limit 1;
